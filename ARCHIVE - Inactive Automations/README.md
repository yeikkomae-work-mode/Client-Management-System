...
Still-current reference files that were **not** archived: `ECO_CLIENTS.md`, `ECO_README.md`, and the setup/config guides in `TEMPLATES/01 Automation Daily Routine/` — those are general reference material, not status claims.
