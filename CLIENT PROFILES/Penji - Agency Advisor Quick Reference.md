...
3. **Identify the decision-maker** — **Corrected 2026-08-17 by Shekinah (Slack):** exclude Founders and Co-Founders entirely, and exclude anyone not related to marketing. Target marketing/creative titles specifically — Creative Director (and variants: Executive/Associate/Senior/Design Director), Marketing Director, Head of Marketing, CMO, Director of Brand/Growth/Ecommerce/Digital Marketing, etc. This supersedes the old "founder/owner → MD → creative director" hierarchy for Gojiberry-sourced marketing lists. Never an info@ address. **Note (2026-08-28):** this rule wasn't actually applied to the live Gojiberry ICP until Round 3 of the signal refresh — Rounds 1–2 still pulled Founder/CEO/President titles. Now corrected; see `Penji - Agency-Eikko Signal & ICP History.md` for the full ICP and every signal tried to date. **Reconfirmed 2026-09-08 (Shekinah via Eikko):** the ICP is **head- and director-level** marketing/creative/client-services titles only — no Founder, Co-Founder, CEO, President, or Managing Director. From 2026-09-08 the Gojiberry agent scrapes only those titles and Dripify outreach goes only to them (Round 5 in the ICP History file). **Confirmed in the 2026-09-08 morning meeting (Alan, acting TL — see `OUTPUT/Meetings/Penji/2026-09-08 - Morning Meeting (ICP enforcement, response targets).md`):** target Head / Director / VP; also exclude **Business Development** titles; locations US first, then Canada, UK after that, EU not pushed away, **no Asia (India, Pakistan)**. Alan confirmed on the call that founder/co-founder leads from the agency list are no longer valid.
...
9. **Route warm replies to Joan within the hour.** No exceptions. Oliver closes. Also post positive responses in the `#response` Slack channel.
    - **Exclusion (effective 2026-09-08, Shekinah via Eikko):** do **not** forward any response from a Founder, Co-Founder, or CEO to the Slack channel — those titles are outside the ICP. Only head-, director- and VP-level responses get forwarded and routed. Business Development titles and Asia-based leads (India, Pakistan) are also not forwarded. You may still converse with a non-ICP reply (Kristine keeps them in a separate non-ICP sheet) but it never goes to the channel. Related standing expectation from the same meeting: **20–40% response rate**; if a week passes with no responses, change the signals/competitor lists immediately rather than waiting — lookalikes seeded from influencer profiles are currently the strongest signal. Check Derbis's comments on bookings daily.
