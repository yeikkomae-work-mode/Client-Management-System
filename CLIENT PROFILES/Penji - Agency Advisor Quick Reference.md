...
9. **Route warm replies to Joan within the hour.** No exceptions. Oliver closes. Also post positive responses in the `#response` Slack channel.
    - **Exclusion (effective 2026-09-08, Shekinah via Eikko):** do **not** forward any response from a Founder, Co-Founder, or CEO to the Slack channel — those titles are outside the ICP. Only head- and director-level responses get forwarded and routed.
